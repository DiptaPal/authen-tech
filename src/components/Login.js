...
const Login = () => {
  ...
  const {signInWithGoogle, signInWithTwitter, signInWithGithub, loginWithEmailAndPassword, resetPassword} = useContext(AuthContext)
  ...
  const handlePasswordReset = () =>{
    ...
    .catch(error => {
      toast.info(error, {autoClose: 1000})
    })
  }
